...
export function RegisterRoutes(app: express.Express) {
    ...
    app.get('/chain-api/data/order/facility/:facilityId/list-open',
        function(request: any, response: any, next: any) {
            ...
            const controller: any = iocContainer.get<OrderController>(OrderController);
    ...
    app.get('/chain-api/data/processing-order/list',
        function(request: any, response: any, next: any) {
            ...
            const controller: any = iocContainer.get<ProcessingOrderController>(ProcessingOrderController);
            if (typeof controller['setStatus'] === 'function') {
                controller.setStatus(undefined);
            }
    ...
    app.get('/chain-api/codebook/action-type/list',
        function(request: any, response: any, next: any) {
            ...
            const controller: any = iocContainer.get<CodebookController>(CodebookController);
            if (typeof controller['setStatus'] === 'function') {
                controller.setStatus(undefined);
            }
    ...
    app.get('/chain-api/data/company-customer/list',
        function(request: any, response: any, next: any) {
            ...
            const controller: any = iocContainer.get<CompanyCustomerController>(CompanyCustomerController);
            if (typeof controller['setStatus'] === 'function') {
                controller.setStatus(undefined);
            }
    ...
    app.post('/chain-api/data/document/upload',
        function(request: any, response: any, next: any) {
            ...
            const controller: any = iocContainer.get<DocumentController>(DocumentController);
            if (typeof controller['setStatus'] === 'function') {
                controller.setStatus(undefined);
            }
    ...
    app.get('/chain-api/data/document-requirement/list',
        function(request: any, response: any, next: any) {
            ...
            const controller: any = iocContainer.get<DocumentRequirementController>(DocumentRequirementController);
            if (typeof controller['setStatus'] === 'function') {
                controller.setStatus(undefined);
            }
    ...
    app.get('/chain-api/data/document-requirement-list/list',
        function(request: any, response: any, next: any) {
            ...
            const controller: any = iocContainer.get<DocumentRequirementListController>(DocumentRequirementListController);
            if (typeof controller['setStatus'] === 'function') {
                controller.setStatus(undefined);
            }
    ...
    app.get('/chain-api/data/facility/list',
        function(request: any, response: any, next: any) {
            ...
            const controller: any = iocContainer.get<FacilityController>(FacilityController);
            if (typeof controller['setStatus'] === 'function') {
                controller.setStatus(undefined);
            }
    ...
    app.post('/chain-api/data/migrations/fix-quote-company-id',
        function(request: any, response: any, next: any) {
            ...
            const controller: any = iocContainer.get<MigrationsController>(MigrationsController);
            if (typeof controller['setStatus'] === 'function') {
                controller.setStatus(undefined);
            }
    ...
    app.get('/chain-api/data/organization/list',
        function(request: any, response: any, next: any) {
            ...
            const controller: any = iocContainer.get<OrganizationController>(OrganizationController);
            if (typeof controller['setStatus'] === 'function') {
                controller.setStatus(undefined);
            }
    ...
    app.get('/chain-api/data/payment/bulk-payment/:dbId',
        function(request: any, response: any, next: any) {
            ...
            const controller: any = iocContainer.get<PaymentsController>(PaymentsController);
            if (typeof controller['setStatus'] === 'function') {
                controller.setStatus(undefined);
            }
    ...
    app.get('/chain-api/data/processing-action/:dbId',
        function(request: any, response: any, next: any) {
            ...
            const controller: any = iocContainer.get<ProcessingActionController>(ProcessingActionController);
            if (typeof controller['setStatus'] === 'function') {
                controller.setStatus(undefined);
            }
    ...
    app.get('/chain-api/data/product/list',
        function(request: any, response: any, next: any) {
            ...
            const controller: any = iocContainer.get<ProductController>(ProductController);
            if (typeof controller['setStatus'] === 'function') {
                controller.setStatus(undefined);
            }
    ...
    app.get('/chain-api/data/semi-product/list',
        function(request: any, response: any, next: any) {
            ...
            const controller: any = iocContainer.get<SemiProductController>(SemiProductController);
            if (typeof controller['setStatus'] === 'function') {
                controller.setStatus(undefined);
            }
    ...
    app.get('/chain-api/data/stock-order/facility/:facilityId/all',
        function(request: any, response: any, next: any) {
            ...
            const controller: any = iocContainer.get<StockOrderController>(StockOrderController);
            if (typeof controller['setStatus'] === 'function') {
                controller.setStatus(undefined);
            }
    ...
    app.get('/chain-api/data/transaction/query',
        function(request: any, response: any, next: any) {
            ...
            const controller: any = iocContainer.get<TransactionController>(TransactionController);
            if (typeof controller['setStatus'] === 'function') {
                controller.setStatus(undefined);
            }
    ...
    app.get('/chain-api/data/user/list',
        function(request: any, response: any, next: any) {
            ...
            const controller: any = iocContainer.get<UserController>(UserController);
            if (typeof controller['setStatus'] === 'function') {
                controller.setStatus(undefined);
            }
    ...
    app.get('/chain-api/data/user-customer/list',
        function(request: any, response: any, next: any) {
            ...
            const controller: any = iocContainer.get<UserCustomerController>(UserCustomerController);
            if (typeof controller['setStatus'] === 'function') {
                controller.setStatus(undefined);
            }
